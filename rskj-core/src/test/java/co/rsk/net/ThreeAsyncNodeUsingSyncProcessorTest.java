...
public class ThreeAsyncNodeUsingSyncProcessorTest {
    ...
    public void synchronizeNewNodeWithTwoPeers() {
        Blockchain b1 = BlockChainBuilder.ofSizeFromCache(30, true);
        Blockchain b2 = BlockChainBuilder.copyAndExtendFromCache(b1, 43, true);
    ...
    public void synchronizeNewNodeWithTwoPeersDefault() {
        Blockchain b1 = BlockChainBuilder.ofSizeFromCache(50, true);
    ...
    public void synchronizeNewNodeWithTwoPeers200Default() {
        Blockchain b1 = BlockChainBuilder.ofSizeFromCache(200, true);
        Blockchain b2 = BlockChainBuilder.ofSize(0, true);
    ...
    public void synchronizeNewNodeWithTwoPeers200Different() {
        Blockchain b1 = BlockChainBuilder.ofSizeFromCache(193, true);
        Blockchain b2 = BlockChainBuilder.copyAndExtendFromCache(b1,7, true);
    ...
    public void synchronizeNewNodeWithThreePeers400Different() {
        ...
        Blockchain b2 = BlockChainBuilder.copyAndExtendFromCache(b1, 200, true);
        Blockchain b3 = BlockChainBuilder.copyAndExtendFromCache(b2, 200, true);
        ...
        Assert.assertArrayEquals(node4.getBestBlock().getHash(), node3.getBestBlock().getHash());
    ...
    public void dontSynchronizeNodeWithShorterChainAndThenSynchronizeWithNewPeer() throws InterruptedException {
        Blockchain b1 = BlockChainBuilder.ofSizeFromCache(30, true);
        Blockchain b2 = BlockChainBuilder.copyAndExtendFromCache(b1, 43, true);
        Blockchain b3 = BlockChainBuilder.copyAndExtendFromCache(b2, 7, true);
    ...
    public void ignoreNewBlockHashesWhenSyncing() {
        Blockchain b1 = BlockChainBuilder.ofSizeFromCache(30, true);
        Blockchain b2 = BlockChainBuilder.copyAndExtendFromCache(b1, 1, true);
